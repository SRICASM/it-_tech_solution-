...
const NeuralNetwork = () => {
    ...
    const particleCount = 1200; // Reduced from 2500 for aggressive performance optimization
    ...
    useFrame((state, delta) => {
        ...
        // Rhythmic Signal Pulse - MOVED TO SHADER FOR PERFORMANCE
        // We no longer update the geometry attributes every frame on the CPU.
        // The vertex shader handles the pulsing using uTime and life attribute.
    });
    ...
    return (
        <div className="fixed inset-0 z-0 pointer-events-none">
            <Canvas
                ...
                dpr={[1, 1.5]} // Cap DPR to 1.5 for performance optimization
                gl={{
                    antialias: true,
